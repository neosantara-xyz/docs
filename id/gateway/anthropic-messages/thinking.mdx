...
Extended Thinking pada endpoint `/anthropic/v1/messages` memungkinkan model Claude memikirkan masalah kompleks sebelum memberikan jawaban. Anda dapat menentukan batas anggaran token pemikiran menggunakan objek `thinking`.
