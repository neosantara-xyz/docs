...
| :-- | :-- | :-- |
| **Orchestrator / Manager** | `neosantara/claude-4.5-sonnet` | Kepatuhan perencanaan multi-langkah dan pendelegasian tugas |
| **Researcher & Deep Reasoning** | `neosantara/deepseek-v4.1-flash` | Analisis mendalam dengan jendela konteks 1M token |
| **Fast Task Worker & Formatter** | `neosantara/gemini-3.8-flash` | Kecepatan eksekusi tinggi dan efisiensi biaya untuk tugas parsing |
