...
Neosantara didukung secara resmi di dalam ekosistem LiteLLM. Anda dapat memanggil model menggunakan prefix `neosantara/<model>` untuk routing, failover multi-model otomatis, dan pelacakan biaya terpusat.
