...
| :-- | :-- | :-- |
| **Orchestrator / Manager** | `neosantara/claude-4.5-sonnet` | Reliable multi-step planning and structured task delegation |
| **Researcher & Deep Reasoning** | `neosantara/deepseek-v4.1-flash` | Thorough analytical output with a 1M token context window |
| **Fast Worker & Formatter** | `neosantara/gemini-3.8-flash` | High throughput and cost efficiency for formatting and quick lookups |
