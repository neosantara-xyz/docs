...
The `/anthropic/v1/messages` endpoint implements official Anthropic Tool Use specifications, where tool parameters are defined using the `input_schema` format.
